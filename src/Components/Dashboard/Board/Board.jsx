...
const Board = () => {
    ...
    const fetchTasksToDo = async (userId, boardDate) => {
        try {
            ...
            console.log("kkkkk",response.data.tasksToDo)
                ...
                <div>
                    <div className={`${StylesBoard.boardCards} ${StylesBoard.scroll}`} style={{ position: 'relative', left: '261px' }}>
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.boardCards_backgroundTitle} style={{ position: 'relative', left: '-111px' }}>Backlog<img src='Assets/collaspe.svg' alt='collaspe' style={{ position: 'relative', right: '-231px',cursor:"pointer" }} onClick={() => setCollasped({ ...collasped, backlog: !collasped.backlog })} /></div>
                        ...
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.boardCards_backgroundTitle} style={{ position: 'relative', left: '-111px' }}>To do<img src='Assets/add.svg' alt='add' style={{ position: 'relative', right: '-211px',cursor:"pointer" }} onClick={onOpenModal} /><img src='Assets/collaspe.svg' alt='collaspe' style={{ position: 'relative', right: '-231px' ,cursor:"pointer"}} onClick={() => {
                        ...
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.boardCards_backgroundTitle} style={{ position: 'relative', left: '-100px' }}>In progress<img src='Assets/collaspe.svg' alt='collaspe' style={{ position: 'relative', right: '-200px',cursor:"pointer" }} onClick={() => setCollasped({ ...collasped, inprogress: !collasped.inprogress })} /></div>
                        ...
                        <div className={StylesBoard.boardCards_background}>
                            <br />
                            <div className={StylesBoard.boardCards_backgroundTitle} style={{ position: 'relative', left: '-111px' }}>Done<img src='Assets/collaspe.svg' alt='collaspe' style={{ position: 'relative', right: '-231px',cursor:"pointer" }} onClick={() => setCollasped({ ...collasped, done: !collasped.done })} /></div>
